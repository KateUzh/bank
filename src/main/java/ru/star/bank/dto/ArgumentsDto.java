...
public class ArgumentsDto {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof ArgumentsDto that)) return false;
        return Objects.equals(productType, that.productType) && Objects.equals(transactionType, that.transactionType) && Objects.equals(mathSign, that.mathSign) && Objects.equals(thresholdSum, that.thresholdSum);
    }

    @Override
    public int hashCode() {
        return Objects.hash(productType, transactionType, mathSign, thresholdSum);
    }
