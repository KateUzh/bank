...
public class DynamicRuleDto {
    ...
    public List<ArgumentsDto> getArguments() { return arguments; }
    public void setArguments(List<ArgumentsDto> arguments) { this.arguments = arguments; }
    public boolean isNegate() { return negate; }
    public void setNegate(boolean negate) { this.negate = negate; }

    @Override
    public boolean equals(Object o) { return o instanceof DynamicRuleDto that &&
            negate == that.negate &&
            Objects.equals(query, that.query) &&
            Objects.equals(arguments, that.arguments); }

    @Override
    public int hashCode() { return Objects.hash(query, arguments, negate); }
}
